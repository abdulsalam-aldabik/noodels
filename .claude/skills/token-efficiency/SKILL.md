...
description: Use to reduce token usage during long-horizon rebuild/new implementation sessions by using structured state files, concise deltas, and reusable command/checklist packs.
---
