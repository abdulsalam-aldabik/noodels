---
name: vision-rebuild
description: Use when implementing the IQ Noodles vision feature from scratch (full rebuild) with phased execution, validation gates, and evidence-driven debugging.
---
...
Use for full reset/new implementation work where existing feature code may be absent or untrusted.
